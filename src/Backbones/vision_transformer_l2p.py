...
from Backbones.prompt import Prompt
...
# add sup
@register_model
def vit_base_patch16_224_sup_l2p(pretrained=False, **kwargs):
    print("use sup")
...
# add ibot
@register_model
def vit_base_patch16_224_ibot_l2p(pretrained=False, **kwargs):
    print("use ibot")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
    ...
    s_ckpt = torch.load(chkpt_dir, map_location="cpu")["model"]
    ckpt = {}
